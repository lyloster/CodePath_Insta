...
import com.example.kris_gram.MainActivity;
import com.example.kris_gram.Post;
import com.example.kris_gram.R;
import com.example.kris_gram.SignupActivity;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (description.isEmpty()) {
                    Toast.makeText(getContext(), "Description cannot be empry", Toast.LENGTH_LONG).show();
                    return;
                }
